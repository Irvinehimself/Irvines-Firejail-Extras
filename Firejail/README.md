...
For convenience, the file [Firejail-ProfilesNotYetSubmittedUpstream](https://github.com/Irvinehimself/TheBeggarsHardeningProject/blob/master/Firejail/Firejail-ProfilesNotYetSubmittedUpstream) contains an an automatically updated list of all my unsubmitted `profiles`.
