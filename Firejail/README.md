...
For convenience, the file [Firejail-ProfilesNotYetSubmittedUpstream](Firejail-ProfilesNotYetSubmittedUpstream) contains an an automatically updated list of all my unsubmitted `profiles`.
