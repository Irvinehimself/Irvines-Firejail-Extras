...
**Note:** The `usr.lib.udisks2.udisksd` profile `deny`'s all operations on `/run/media` and `/media`. The reasoning for this is explained fully in the [HsTools readme](TheBeggarsHardeningProject/tree/master/HsTools#udisks2-hardening)
